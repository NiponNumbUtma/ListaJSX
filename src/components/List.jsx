...
function Todo() {
  ...
  return (
    <div>
      ...
      <button onClick={() =>  deleteTo_do(index)} style={{color:"red"}}><svg height="36px" width="36px" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
    ...
    </svg><span class="now">En mantenimiento..</span><span class="play">Borrar todo</span></button>
